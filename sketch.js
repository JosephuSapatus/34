...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   display.scale = 0.2
   display.addAnimation("emptystar",emptystar)
   display.addAnimation("onestar",onestar)
   display.addAnimation("twostar",twostar)
   display.changeAnimation("empty")
  ...
  ground = new Ground(300,height,width-50,20);
  blink.frameDelay = 20;
  eat.frameDelay = 20;
...
function draw() 
{
  ...
  if(collide(fruit,star,20)==true){
    star.visible = false
    display.changeAnimation("onestar")
  }
  if(collide(fruit,star2,20)==true){
    star2.visible = false
    display.changeAnimation("twostar")
  }
